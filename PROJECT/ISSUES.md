...
| U-008 | 版本 | **VERSION 不统一** — VERSION 文件 1.3.2 ≠ SDK 1.3.1 ≠ CHANGELOG 1.3.3 | 🔴 | 呱呱 | P0-P2审计 23:35 |
| U-009 | 异构 | **ZS0003 Python 3.14 ≠ ZS0001/2 3.13** — GIL 移除差异，并发行为风险 | 🔴 | 火鸡儿 | P0-P2审计 23:35 |
| U-010 | 版本 | **ZS0001 adapter.sh 无版本注释** — 三端唯一没标，违反 VERSION-STANDARD | 🔴 | 呱呱 | P0-P2审计 23:35 |
| U-011 | 代码 | **双循环检测器未合并** — 吉量 _is_confirm_loop + 呱呱 ACK skip，重叠不完整 | 🔴 | 吉量评审/呱呱合并 | P0-P2审计 23:35 |
| U-012 | 队列 | **队列重新积压** — 清完1h后 59/57/23。去重只拦 dispatch，入队仍在涨 | 🔴 | 呱呱 | P0-P2审计 23:35 |
...
| U-105 | 协议 | PROTOCOL_VERSION=1.0 落后协议文档 v1.2（含已读回执） | 🟡 | 呱呱 | P0-P2审计 23:35 |
| U-106 | adapter | adapter.sh 版本分裂未根本解决 — ZS0001(无)/ZS0002(v1.3)/ZS0003(v2.1) | 🟡 | 火鸡儿/吉量 | P0-P2审计 23:35 |
| U-107 | 运维 | healthd 查询异常 — 679条事件但 agent 状态查询失败 | 🟡 | 呱呱 | P0-P2审计 23:35 |
